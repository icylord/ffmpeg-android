...
./configure --target-os=linux \
    ...
    --sysroot=$PLATFORM \
    --extra-cflags="-I$X264_ROOT -fvisibility=hidden -fdata-sections -ffunction-sections -Os -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 $OPTIMIZE_CFLAGS " \
    --disable-shared \
    --enable-static \
    --enable-small \
    --extra-ldflags="-L$X264_ROOT -Wl,-rpath-link=$PLATFORM/usr/lib -L$PLATFORM/usr/lib -nostdlib -lc -lm -ldl -llog" \
    --disable-everything \
    --enable-libx264 \
